    ...
    <ul class=" navbar-right">
      <li class="nav-item dropdown open" style="padding-left: 10px;">
        <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
          <img src="build/images/user.png" alt=""><?php echo $_SESSION['UsuarioNome']; ?>
        </a>
        <div class="dropdown-menu dropdown-usermenu " aria-labelledby="navbarDropdown">
          <a class="dropdown-item"  href="?page=view_perfil"> Perfil</a>
            <a class="dropdown-item"  href="javascript:;">
              <span>Configurações</span>
            </a>
        <a class="dropdown-item"  href="javascript:;">Ajuda</a>
          <a class="dropdown-item"  href="base/logout.php"><i class="fa fa-sign-out "></i> Sair</a>
        </div>
      </li>
